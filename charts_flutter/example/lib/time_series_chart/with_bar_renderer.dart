...
class TimeSeriesBar extends StatelessWidget {
  ...
  static List<charts.Series<TimeSeriesSales, DateTime>> _createRandomData() {
    ...
    final data = [
      TimeSeriesSales(DateTime(2017, 9), random.nextInt(100)),
  ...
  Widget build(BuildContext context) => charts.TimeSeriesChart(
        ...
        // This can also be one of the custom renderers of the time series
        // chart.
        defaultRenderer: charts.BarRendererConfig<DateTime>(),
        // It is recommended that default interactions be turned off if using
        // bar renderer, because the line point highlighter is the default for
        // time series chart.
  ...
  static List<charts.Series<TimeSeriesSales, DateTime>> _createSampleData() {
    final data = [
      TimeSeriesSales(DateTime(2017, 9), 5),
