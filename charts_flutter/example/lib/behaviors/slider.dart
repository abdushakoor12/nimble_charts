...
///
/// A [charts.Slider] behavior is added manually to enable slider controls,
/// with an initial position at 1 along the domain axis.
///
...
/// set.
///
/// [charts.Slider.moveSliderToDomain] can be called to programmatically
/// position the slider. This is useful for synchronizing the slider with
/// external elements.
